<footer id="footer" class="dark">
    ...
    <!-- Copyrights
    ============================================= -->
    <div id="copyrights" style="background-color:#961A2C;">
        <div class="container">

            <div class="row col-mb-30">

                <div class="col-md-12 text-center text-white">
                    Copyrights &copy; Kementerian Pekerjaan Umum dan Perumahan Rakyat 2022.<br>
                    <div class="copyright-links d-none"><a href="#">Terms of Use</a> / <a href="#">Privacy Policy</a></div>
                </div>

                <div class="col-md-12 text-center text-md-end d-none">
